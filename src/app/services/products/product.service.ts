...
export class ProductService {
  ...
  getProducts(searchedProduct: string, searchedCountry: string, searchedCategory: string) {
    ...
    const url = `${this.url}/filtered/${searchedProduct}/${searchedCountry}/${searchedCategory}`;
